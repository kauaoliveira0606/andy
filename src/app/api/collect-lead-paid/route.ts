// Same-origin proxy for /paid's opt-in forms. The browser posts here (no CORS issues),
// and this forwards the lead server-side to Zapier, which has no CORS restriction.
import { NextRequest, NextResponse } from "next/server";

const ZAPIER_WEBHOOK_URL = "https://hooks.zapier.com/hooks/catch/21197109/4tuuher/";
