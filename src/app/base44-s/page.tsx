...
import styles from "./base44s.module.css";
...
const LINK = "https://re.aistorebuilder.com/base44-pricing?subid=ecomsimulation&sharedid=Sahil";

export default function Base44SPage() {
